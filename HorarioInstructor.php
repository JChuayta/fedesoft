...
<body>
  ...
  if (!empty($_SESSION["usu_usuario"])) {
    ...
    <header>
      <table>
        <tr>
          ...
          <td class="tdLetras">
            <h3><b>SISTEMA DE GESTION DE HORARIOS PARA LABORATORIOS</b></h3>
            <h4><b>SIGHO</b></h4>
          </td>
          <td class="iD">
            <div>
    ...
    <main id="ContenedorCuerpo">
      <nav class="nav-bar">
        ...
        <div class="nav-hold">
          <div class="nav-logo">
            <center>
              <div class="buscar"><input><button><img src="IconosImagenes/buscar.svg" style="width:70%;"></button></div>
            </center>
        ...
        <table>
          ...
          <tr>
            ...
            <div id="lol">
              ...
              <td class="RowTabla">
                <center>
                  <form method="POST" action="ConfigHorario.php">
                      ...
                      <?php
                        ...
                        if ($resultado = $mysqli->query($consulta)) {
                          ...
                          while ($i <= $CantidadHoras) {
                            ...
                            echo "<tr>";
                            echo "<td>$i</td><td>$HoraInicio - ";
                            $horaFinal = date('H:i:s', strtotime($HoraInicio) + $Intervalo);
                            echo $horaFinal;
    ...
    <div class="footer">
      <center>Laboratorio ADSI - 1193938, Malambo © 2017</center>
    </div>
</body>
