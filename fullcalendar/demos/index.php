		...
		<div class="container">
			...
			<?php
				...
				<div class="row">
					<center>
						<h3>
							HORARIO DEL AMBIENTE <p id="TIPOHORARIO"></p>
						</h3>
					</center>
				...
				<div class="row BusquedaPorInstructor nover">
					<label class="label-control">SELECCIONAR DOCENTE</label>
				...
				<div class="row">
					...
					<?php if (isset($_SESSION['instructor'])) {
							...
							?>
						<button id="ConfigHoras" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#ModalConfiguracionHoras"><b>========> Configurar y Generar Horario <========</b> </button> <input type='hidden' id="sesionInstructor" value="<?php echo $_SESSION['instructor'] ?>">
