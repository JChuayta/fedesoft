...
<?php  endif; ?>
	<h3 class="title"><i class="material-icons" aria-hidden="true">contact_mail</i> DOCENTES </h3>

</div>
			
<div class="card-content table-responsive">
<a href="#" class="btn btn-success" data-toggle="modal" data-target="#ModalRegistroInstructor">Agregar Docentes</a>
		...
		<h4 class="modal-title">Software Lab</h4><hr />
		  <div class="card-content">
				...
				<SELECT type="select" name="TipoInstructor" id="TipoIns" class="form-control">
				 		   <OPTION value="">.::TIPO DOCENTE::.</OPTION>
				 		   <OPTION value="Fuera de sede">NUEVO</OPTION>
				 		   <OPTION value="Desplazado">CON ANTIGUEDAD</OPTION>
