...
<?php  endif; ?>
	<h3 class="title"><i class="fa fa-graduation-cap" aria-hidden="true"></i>  MATERIAS</h3>
</div>
<div class="card-content table-responsive">
<a href="#" class="btn btn-success" data-toggle="modal" data-target="#ModalRegistroPrograma">Agregar Materia</a>
	...
	<div class="modal-header">
		...
		<h4 class="modal-title">SIGHO</h4><hr />
		  <div class="card-content">
				...
				<div class="form-group ">
					<label for="Codigo">Sigla de Materia</label>
